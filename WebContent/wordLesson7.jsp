...
<script type="text/javascript">
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		document.querySelector('#micBtn1').onclick = function() {
			wavesurfer1.load('Audio/word/7.mp3');
			wavesurfer1.play();
		};
	});
</script>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3 col-xs-4 text-center">
				...
				<img src="img2/1186945_10202925496287057_3269783426668126358_n.jpg" class="img-responsive"><!-- เช็คเสียงว่าถูกต้องหรือไม่ -->
			...
			<div class="col-md-3 col-xs-4 text-center">
				...
				<video width="350" height="400" controls="" autoplay="" class="img-responsive">
					<source src="VDO/word/7.mp4" type="video/mp4">
				</video>
			</div>
