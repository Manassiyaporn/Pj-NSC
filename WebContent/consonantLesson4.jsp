...
<script type="text/javascript">
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		document.querySelector('#micBtn1').onclick = function() {
			wavesurfer1.load('Audio/consonant/ko.mp3');
			wavesurfer1.play();
		};
	});
</script>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-2 text-center" onload="readvdo()">
				...
				<%
						...
						try {
							...
							while (rs.next()) {
								String id = rs.getString("Consonant_id");
								String name = rs.getString("Consonant_word");
								String address = rs.getString("address_con");
								out.println(" <option value=" + address + ">" + name
										+ "</option>");
							}
							stmt.close();
							con.close();
			...
			<div class="col-md-3 col-xs-4 text-center">
				<!--2 แอนนิเมชั่น-->
				<img src="img2/1186945_10202925496287057_3269783426668126358_n.jpg">
			...
			<div class="col-md-3 col-xs-4 text-center" id="vdoVowel">
				...
				<video width="350" height="400" controls="" autoplay="" class="img-responsive">
					<source src="VDO/consonant/ko.mp4" type="video/mp4">
				</video>
			</div>
...
//                console.log("final:    " + final_transcript);  
                ...
                if(final_transcript.length > 0) { // นับความยาวข้อความ ถ้ามากกว่า 0 แสดงว่ามีค่า  
                	...
                	consonant_con = final_transcript;
                    $('#transcript').val(consonant_con);
                }  
            };  
