...
<script type="text/javascript">
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		document.querySelector('#micBtn1').onclick = function() {
			wavesurfer1.load('Audio/vowel/11.mp3');
			wavesurfer1.play();
		};
	});
</script>
		...
		<div class="row">
			...
			<div class="col-md-3 col-xs-4 text-center" id="vdoVowel">
				...
				<video width="350" height="400" controls="" autoplay="" class="img-responsive">
					<source src="VDO/vowel/11.mp4" type="video/mp4">
				</video>
			</div>
						...
						.click(
								function(e) {
									...
									if (recognizing) { // ภ้าทำงานอยู่ เมื่อกดก็จะเป็นหยุด  
										...
										$('#start_button').html(
												'Click to Start Again'); // เปลี่ยนข้อความปุ่ม แนะนำกดใหม่ ถ้าต้องการจดจำเสียงอีกครั้ง  
