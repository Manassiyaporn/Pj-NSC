...
<script type="text/javascript">
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		document.querySelector('#micBtn1').onclick = function() {
			wavesurfer1.load('Audio/word/1.mp3');
			wavesurfer1.play();
		};
	});
</script>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-2 text-center" onload="loadWords()">
				...
				<br> <br> กรุณาเลือกคำ <br /> <select
					class="form-control" id="list_word" name="list_word">
					<!--%
						try {
							Class.forName("com.mysql.jdbc.Driver");
			...
			<div class="col-md-3 col-xs-4 text-center">
				...
				<video width="350" height="400" controls="" autoplay="" class="img-responsive">
					<source src="VDO/word/1.mp4" type="video/mp4">
				</video>
			</div>
